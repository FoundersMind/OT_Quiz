...
SECRET_KEY = 'django-insecure-)y!s8$n5%46ai6i_x%o=o61u35ldz1pspi(qio_563y$gt-=i6'
...
# ✅ Where collectstatic will put final files
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# ✅ Include this ONLY because you confirmed you have a top-level static/ folder
STATICFILES_DIRS = [
